<?php 
 ...
 include "functions.php"; 
    ...
    $proizvodi_glavni_tekst = $_POST['glavni_tekst'];
    $proizvodi_glavni_tekst_en = $_POST['glavni_tekst_en'];
    $proizvodi_alt = check_input($_POST['alt']);
    $proizvodi_alt_en = check_input($_POST['alten']);
    $proizvodi_datum = date("Y-m-d");
    ...
    if(isset($_POST['proizvodi_id']) && empty($_POST['proizvodi_id'])){
        $array_proizvodi = array("proizvodi_naziv"=>"{$proizvodi_naziv}","proizvodi_naziv_en"=>"{$proizvodi_naziv_en}","proizvodi_opis"=>"{$proizvodi_opis}","proizvodi_opis_en"=>"{$proizvodi_opis_en}","proizvodi_uvodni_tekst"=>"{$proizvodi_uvodni_tekst}","proizvodi_uvodni_tekst_en"=>"{$proizvodi_uvodni_tekst_en}","proizvodi_glavni_tekst"=>"{$proizvodi_glavni_tekst}","proizvodi_glavni_tekst_en"=>"{$proizvodi_glavni_tekst_en}","proizvodi_cover"=>"{$proizvodi_cover_name}","proizvodi_uvodna_foto"=>"{$proizvodi_upload_name}","proizvodi_alt"=>"{$proizvodi_alt}","proizvodi_alt_en"=>"{$proizvodi_alt_en}","proizvodi_datum_unosa"=>"{$proizvodi_datum}","proizvodi_status"=>"neaktivan");
